...
public class Application {
	...
	protected static final float FINAL_LEARNING_RATE = 0.5f; //Must be between 0 and 1
	protected static final float LEARNING_RATE_INCREMENT = 0.1f; //Change here, do not set to 0
